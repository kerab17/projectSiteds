...
public class manualUsuarioPage {
    WebDriver driver;

    public manualUsuarioPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    By pantallaManual = By.xpath("//*[@id=\"2373\"]/li[1]");
    ...
    public void setPantallaManual(){
        // Hacer clic en el botón que abre la nueva pestaña con el PDF
        driver.findElement(pantallaManual).click();
